#pragma checksum "/home/gustavo/Documents/projeto_sua_voz/SuaVoz/SuaVoz/Views/Home/Privacy.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "aaecf73e59ee92e94bdd6d75cd09737acb06d055"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"aaecf73e59ee92e94bdd6d75cd09737acb06d055", @"/Views/Home/Privacy.cshtml")]
    ...
    public class Views_Home_Privacy : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "/home/gustavo/Documents/projeto_sua_voz/SuaVoz/SuaVoz/Views/Home/Privacy.cshtml"
...
#nullable disable
    ...
    <p>Não compartilhamos informações de identificação pessoal pu");
            WriteLiteral(@"blicamente ou com terceiros, exceto quando exigido por
        lei.
    </p>
    ...
    <p>Como é prática comum em quase todos os sites profissionais, es");
            WriteLiteral(@"te site usa cookies, que são pequenos arquivos
        baixados
    ...
    <p>Você pode impedir a configuração de cookies ajustando ");
            WriteLiteral(@"as configurações do seu navegador (consulte a Ajuda do
   ...
   ");
            WriteLiteral(@"         dessa ação. Isso evita que você precise fazer login sempre que visitar uma nova página. Esses cookies são
        ...
        <li> Cookies relacionados ");
            WriteLiteral(@"a pesquisas<br><br> Periodicamente, oferecemos pesquisas e questionários para fornecer
        ...
        <li> Cookies de preferências do site<br><br> Para proporcionar uma ótima experiência neste site, fornecemos a
            ...
            suas
            preferênci");
            WriteLiteral(@"as, precisamos definir cookies para que essas informações possam ser chamadas sempre que você
    ...
    <ul>
        <li> As análises de");
            WriteLiteral(@" terceiros são usadas para rastrear e medir o uso deste site, para que possamos continuar
        ...
        <li> À medida que vendemos produtos, é importante entendermos as estatísticas sobre quantos visitantes de nosso
            site
            realmente compram e, portanto, esse é o tipo de dados que esses cookies rastrearão. Isso é importante para
            você,
            pois sig");
            WriteLiteral(@"nifica que podemos fazer previsões de negócios com precisão que nos permitem analizar nossos custos
            de
    ...
    <ul>
        ...
        <li>B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, <a
            ...
            humanos;</li>
        <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Sua Voz, de seus fornecedores
            ou
      ");
            WriteLiteral(@"      terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou
            software
