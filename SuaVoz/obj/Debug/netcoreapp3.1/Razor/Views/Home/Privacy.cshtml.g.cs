#pragma checksum "/home/gustavo/Documents/projeto_sua_voz/SuaVoz/SuaVoz/Views/Home/Privacy.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "57abcdefe49cbd5fe76fa748fae8df656352437c"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"57abcdefe49cbd5fe76fa748fae8df656352437c", @"/Views/Home/Privacy.cshtml")]
...
");
            WriteLiteral(@"    <h3>O que são cookies?</h3>
    ...
    <p>Utilizamos cookies por vários motivos, detalhados abaixo. Infelizmente, na maioria dos casos, não existem opções
        ...
        deles,
        caso sejam usados ​​para fornecer um serviço que você ");
            WriteLiteral(@"usa.</p>
    ...
    <ul>
        <li> Cookies relacionados à conta<br><br> Se você criar uma conta connosco, usaremos cookies para o
            ...
            ao sair.<br><br> </li>
        <li> Cookies re");
            WriteLiteral(@"lacionados ao login<br><br> Utilizamos cookies quando você está logado, para que possamos lembrar
        ...
        <li> Cookies de preferências do site<br><br> Para proporcionar uma ótima experiência neste site, fornecemos a
            funcionalidade para definir suas preferências ");
            WriteLiteral(@"de como esse site é executado quando você o usa. Para lembrar
            suas
    ...
    <p>Para mais informações sobre cookies do Goog");
            WriteLiteral(@"le Analytics, consulte a página oficial do Google Analytics.</p>
    <ul>
        ...
        <li> À medida que vendemos produtos, é importante entendermos as estatísticas sobre quantos visitantes de nosso
            site
            realmente compram e, portanto, esse é o tipo");
            WriteLiteral(@" de dados que esses cookies rastrearão. Isso é importante para
            você,
    ...
    <ul>
        ...
        <li>B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, <a style='color: inherit !important; text-decoration:none !important;' href='https://jogoshoje.io'>jogos de
                hoje</a> ou azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos
            humanos;</li>
        <li>C) Não causar danos aos sistemas físicos (ha");
            WriteLiteral(@"rdwares) e lógicos (softwares) do Sua Voz, de seus fornecedores
            ou
    ...
    <a href=""https://drive.google.com/file/d/1QMLB-h_uJT2fbcpMVBR1KdpZW4VFXp3A/view?usp=sharing"" download=""lei.pdf"" target=""_blank"">Lei de proteção de dados</a>
</div>
